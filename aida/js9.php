...
<title>JS9: astronomical image display everywhere</title>
	...
	<ul class="js9demo">
	  <li><a href='js9/js9basics.html' target='_blank'>the basics</a>
	  <li><a href='js9/js9sizes.html' target='_blank'>setting the size of the JS9 display</a>
	  <li><a href='js9/js9menustyles.html' target='_blank'>menubar styles</a>
	  <li><a href='js9/js9bespoke.html' target='_blank'>web page control</a>
	  <li><a href='js9/js9preload.html' target='_blank'>preloading images into JS9</a>
	</ul>
	<b>multiple displays:</b>
	<ul class="js9demo">
	  <li><a href='js9/js9multi.html' target='_blank'>multiple instances of JS9</a> 
	  <li><a href='js9/js9super.html' target='_blank'>control multiple displays with one menu</a>
	  <li><a href='js9/js9create.html' target='_blank'>creating a JS9 instance dynamically</a> 
	  <li><a href='js9/js9sync.html' target='_blank'>syncing images in multiple displays</a> 
	</ul>
	<b>plugins:</b>
	<ul class="js9demo">
	  <li><a href='js9/js9plugins.html' target='_blank'>adding plugins to JS9</a> 
	  <li><a href='js9/js9imexam.html' target='_blank'>the imexam plugin</a> 
	  <li><a href='js9/js9panzoom.html' target='_blank'>pan and zoom</a> 
	  <li><a href='js9/js9cat.html' target='_blank'>overlaying catalogs</a>
	  <li><a href='js9/js9dysel.html' target='_blank'>dynamic selection of displays</a> 
	</ul>
	<b>colors:</b>
	<ul class="js9demo">
	  <li><a href='js9/js9blend.html' target='_blank'>image blending</a> 
	  <li><a href='js9/js9rgb.html' target='_blank'>RGB composite images</a> 
	  <li><a href='js9/js9cmaps.html' target='_blank'>creating new colormaps</a>
	</ul>
	<b>data analysis:</b>
	<ul class="js9demo">
	  <li><a href='js9/js9analysis.html' target='_blank'>remote data analysis</a> 
	  <li><a href='js9/js9onchange.html' target='_blank'>running tasks when a region changes</a>
	</ul>
	<b>FITS support:</b>
	<ul class="js9demo">
	  <li><a href='js9/js9bitpix.html' target='_blank'>displaying different FITS datatypes</a> 
	  <li><a href='js9/js9large.html' target='_blank'>support for large FITS files</a>
	</ul>
	<b>not often needed:</b>
	<ul class="js9demo">
	  <li><a href='js9/js9allinone.html' target='_blank'>using the all-in-one files</a> 
	  <li><a href='js9/js9pngvsfits.html' target='_blank'>PNG representation files vs FITS files</a> 
	</ul>
    </div>
    <div id="status" class="tabcontent mytabcontent">
      <b>Recent Public Releases:</b>
      <p>
      <b>Release 2.3 (05/01/19)</b> a wealth of UI improvements
      (especially regions and menus), a smattering of bug fixes, and a
      cool colormap-generating plugin.
      <p>
      <b>Release 2.2 (10/09/18)</b> adds support for synchronized
      images, separate/gather images, mosaic images, user-defined and
      Mac-style menus, browser-based counts in regions, coordinate
      grids.
      <p>
      <b>Release 2.1 (05/10/18)</b> adds a graphical toolbar plugin, the
      ...
      <p>
      <b>Release 2.0 (09/27/17)</b> use WebAssembly where possible to
    ...
    <div id="get" class="tabcontent mytabcontent">
      ...
      <ul>
      <li><a href="downloads/js9-2.3.tgz">js9 v2.3</a>
      </ul>
    ...
    git pull
      ...
      For Mac users, a simplified <b>desktop app</b> is available on GitHub:
      <ul>
      <li> <a href="https://github.com/ericmandel/js9app" target="_blank" rel="noopener noreferrer">js9app on GitHub</a>
      </ul>
    ...
    <div id="thanks" class="tabcontent mytabcontent">
      ...
      <li> appcropolis for double click support (appcropolis.com/blog/howto/implementing-doubletap-on-iphones-and-ipads/)
