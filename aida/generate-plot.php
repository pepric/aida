					...
					<div class="panel-body">
						<form id="detector_form" class="form-horizontal form-bordered" method="" action="" novalidate = "novalidate">
							...
							<div class="form-group" id="hidden-fields">
								...
								<input type="hidden" name="plot_type" id = "plot_type" value="<?php echo $_GET['plot']; ?>" disabled></input>
						...
						<div class="col-md-12" style="text-align:right">
							<button class="btn btn-primary" id="advanced_a" onclick="set_advanced_stats()">Advanced Statistics</button>
